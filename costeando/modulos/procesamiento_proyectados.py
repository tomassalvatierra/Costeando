...
def procesar_proyectados_puro(
    ...
    try:
        ...
        path_proyectado = os.path.join(carpeta_guardado, "Costos Proyectados.xlsx")
        path_proyectado_comercial = os.path.join(carpeta_guardado, "Costos Proyectados PARA COMERCIAL.xlsx")
