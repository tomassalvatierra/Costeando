...
def procesar_segundo_comprando(
    ...
    try:
        ...
        if ruta_importador_descuentos:
            ...
            lista_dfs = [(df_calculo_comprando,"Comprando"),(df_costos_especiales,"Base Desc."),(df_importador_descuentos,"Importador")]
            ...
            lista_dfs = [(df_calculo_comprando,"Comprando"),(df_costos_especiales,"Base Desc.")]
            lista_dfs = [estandarizar_columna_producto(df, n) for df, n in lista_dfs]
        ...
        df_calculo_comprando.loc[mascara_superado_75, "DESCUENTO ESPECIAL"] = (
            df_calculo_comprando.loc[mascara_superado_75, "DESCUENTO ESPECIAL"] - exceso).clip(lower=0)
        ...
        return {"comprando": path_comprando, "especiales": path_especiales, "importador": path_importador}
    except Exception as e:
        logger.error(f"Error en Segundo Comprando: {e}", exc_info=True)
        raise