...
def procesar_proyectados_puro(
    ...
    try:
        ...
        path_proyectado = os.path.join(carpeta_guardado, f"{fecha_hoy} Costos Proyectados C{camp_inicial}-{anio_inicial}.xlsx")
        path_proyectado_comercial = os.path.join(carpeta_guardado, f"{fecha_hoy} Costos Proyectados C{camp_inicial}-{anio_inicial} PARA COMERCIAL.xlsx")
